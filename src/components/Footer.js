    ...
    <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          ...
          <Link href="https://www.linkedin.com/in/mohammad-shahnowaz/" className='text-2xl'><FaLinkedin /></Link>
      ...
      {/* Footer Bottom */}
      <aside>
        <p>Copyright © {new Date().getFullYear()} - All rights reserved by GadgetZoom Ltd</p>
      </aside>
    </footer>
  );
};
